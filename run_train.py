...
group.add_argument('--temp', action='store_const',  const='trained_models/temp', dest='exp_name', help='sets exp_name to temp')

model_parser.add_argument('--transformer',  default='gpt_neo',     type=str,  help='[bert, roberta, electra ...]')
...
train_parser.add_argument('--train_path',  default='tv_data/all_train.json', type=str,  help='')
train_parser.add_argument('--dev_path',    default='tv_data/all_test.json',  type=str,  help='')
...
if __name__ == '__main__':
    ...
    #checks all arguments are expected
