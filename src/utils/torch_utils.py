...
def load_tokenizer(system:str)->'Tokenizer':
    ...
    elif system == 'dialo_gpt'     : tokenizer = AutoTokenizer.from_pretrained("microsoft/DialoGPT-medium")
...
def load_lm_transformer(system:str)->'Model':
    ...
    elif system == 'dialo_gpt'     : trans_model = AutoModelForCausalLM.from_pretrained("microsoft/DialoGPT-medium")
